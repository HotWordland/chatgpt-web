...
const asavtarUrl = '//avatars.githubusercontent.com/u/6984865?v=4';

const initialMessages = [
  {
    type: 'text',
    content: { text: '您好，我是情热大陆，有啥想问我的吗' },
    user: { avatar: asavtarUrl },
  },
];
...
function App() {
  ...
  function onGenCode(question) {
    ...
    let url = 'completion';
    // let url = 'http://192.168.2.49:8080/completion';
    axios
      .post(url, {
